...
class GraphStore(Protocol):
    ...
    async def get_node(self, label: str, key_field: str, key_value: str) -> dict[str, Any] | None:
...
def node_to_text(label: str, props: dict) -> str:
    ...
    for field in ("description", "notes", "rationale", "solution", "context", "body"):
...
class HybridSearchEngine:
    ...
    async def search(self, query: str, limit: int = 10) -> list[SearchResult]:
        ...
        v_results = (
            await self.vector.search_vectors(query_vec, limit=self.config.vector_k)
            if query_vec
            else []
        )
